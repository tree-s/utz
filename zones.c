...
const unsigned char zone_names[376] = {
    ...
    'C','h','i','c','a','g','\0',6, // zone 6
    'D','e','n','v','e','r','\0',7, // zone 7
    'H','a','l','i','f','a','\0',8, // zone 8
    'L','o','s',' ','A','n','\0',9, // zone 9
    'M','a','n','a','u','s','\0',10, // zone 10
    'M','e','x','i','c','o','\0',11, // zone 11
    'N','e','w',' ','Y','o','\0',12, // zone 12
    'G','o','d','t','h','a','\0',13, // zone 13
    'P','h','o','e','n','i','\0',14, // zone 14
    'S','a','n','t','i','a','\0',15, // zone 15
    'S','t',' ','J','o','h','\0',16, // zone 16
    'B','a','n','g','k','o','\0',17, // zone 17
    'D','u','b','a','i',' ','\0',18, // zone 18
    'H','o','n','g',' ','K','\0',19, // zone 19
    'J','e','r','u','s','a','\0',20, // zone 20
    'K','a','r','a','c','h','\0',21, // zone 21
    'K','a','t','m','a','n','\0',22, // zone 22
    'K','o','l','k','a','t','\0',23, // zone 23
    'I','s','t','a','n','b','\0',24, // zone 24
    'S','e','o','u','l',' ','\0',25, // zone 25
    'S','h','a','n','g','h','\0',26, // zone 26
    'K','u','a','l','a',' ','\0',27, // zone 27
    'T','e','h','r','a','n','\0',28, // zone 28
    'T','o','k','y','o',' ','\0',29, // zone 29
    'R','a','n','g','o','o','\0',30, // zone 30
    'A','d','e','l','a','i','\0',31, // zone 31
    'B','r','i','s','b','a','\0',32, // zone 32
    'D','a','r','w','i','n','\0',33, // zone 33
    'H','o','b','a','r','t','\0',34, // zone 34
    'P','e','r','t','h',' ','\0',35, // zone 35
    'S','y','d','n','e','y','\0',36, // zone 36
    'U','T','C',' ',' ',' ','\0',37, // zone 37
    'A','t','h','e','n','s','\0',38, // zone 38
    'B','e','l','g','r','a','\0',39, // zone 39
    'L','o','n','d','o','n','\0',40, // zone 40
    'M','o','s','c','o','w','\0',41, // zone 41
    'A','u','c','k','l','a','\0',42, // zone 42
    'G','u','a','m',' ',' ','\0',43, // zone 43
    'H','o','n','o','l','u','\0',44, // zone 44
    'M','i','d','w','a','y','\0',45, // zone 45
    'M','a','j','u','r','o','\0',46, // zone 46
};
